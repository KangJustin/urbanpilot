  ...
  'inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium border',
  {
    variants: {
      tone: {
        ...
        'civic-category-climate': 'bg-civic-surface-secondary border-civic-border text-civic-accent',
        'civic-category-accessibility': 'bg-civic-surface-secondary border-civic-border text-civic-accessibility',
        'civic-category-housing': 'bg-civic-surface-secondary border-civic-border text-civic-housing',
      },
    },
